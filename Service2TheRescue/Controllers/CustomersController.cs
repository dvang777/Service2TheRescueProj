...
using Service2TheRescue.Models;
...
namespace Service2TheRescue.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var UserInfo = db.Customers.Where(c => c.CustomerID == UserID);
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Address,City,State,ZipCode")] Customer customer)
        {
